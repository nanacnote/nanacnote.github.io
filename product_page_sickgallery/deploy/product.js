...
function showPopupMajor(){
    ...
    function linksContent(e){
        let temp = '<div class="nav-links-info-header">ghh</div><div class="nav-links-info-body">ghhg</div>';
    ...
    if(this.textContent === "Artist"){
        ...
        major_linksPopup_content.innerHTML = linksContent(this.textContent);
